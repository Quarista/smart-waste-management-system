...
class _HomePageDesktopState extends State<HomePageDesktop> {
  ...
  String imageUrl = 'https://i.ibb.co/FqgHp43y/waste-management-desktop.png';
  void getImageUrl() {
    ...
    _sessionSubscription = docRef.snapshots().listen((snapshot) {
      if (snapshot.exists) {
        ...
        final imageUrlList = data['DesktopImage'] ??
            [
              'https://i.ibb.co/FqgHp43y/waste-management-desktop.png',
              'https://www.mida.gov.my/wp-content/uploads/2022/09/1-scaled.jpg',
            ];
        ...
        setState(() {
          imageUrl = 'https://i.ibb.co/FqgHp43y/waste-management-desktop.png';
        });
      }
    });
  }
                  ...
                  children: [
                    ...
                    Image.network(
                      ...
                      errorBuilder: (context, error, stackTrace) {
                        return Image.asset(
                          'assets/images/waste_management_desktop.png',
                          fit: BoxFit.cover,
                        );
                      },
                    ),
                    ...
                    Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            Colors.transparent,
                            appColours.scaffoldColour.withOpacity(0.2),
                            appColours.scaffoldColour,
                          ],
                        ),
                      ),
                    ),
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: theme.brightness == Brightness.dark
                          ...
                          : AppColours().mainThemeColour.withOpacity(0.3),
                      blurRadius: 10,
                      offset: const Offset(0, 4),
                    ),
                  ],
